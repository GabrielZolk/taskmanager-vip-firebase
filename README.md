...
# Aplicação de Gerenciamento de Tarefas com banco de dados no Frontend

Esta é uma aplicação de gerenciamento de tarefas desenvolvida no frontend utilizando a biblioteca de componentes Material-UI em conjunto com o React e Firebase. Ela permite que os usuários criem, editem, excluam e filtrem tarefas, além de marcar tarefas como concluídas ou incompletas.

## Funcionalidades

- Sistema de autenticação do usuário com registro e login (Banco de dados real).
...
# Task Management Application with Frontend Database

This is a task management application developed on the frontend using the Material-UI component library in conjunction with React and Firebase. It allows users to create, edit, delete, and filter tasks, as well as mark tasks as complete or incomplete.

## Features

- User authentication system with registration and login (Real database).
